...
const SolutionCard = ({ 
  ...
  return (
    <div
      ...
      className="border border-white/[0.2] group/canvas-card flex flex-col items-center justify-between max-w-sm w-full mx-auto p-6 relative h-[35rem] overflow-hidden rounded-lg bg-black/50 backdrop-blur-sm"
    >
      {/* Corner Icons */}
      ...
      {/* Corner Ribbon Badge */}
      <div className="z-999 absolute top-0 left-0 overflow-hidden w-32 h-32 pointer-events-none">
...
{/* Description & Button Switch Area */}
<div className="relative w-full h-[4.5rem] flex items-center justify-center mt-2">
  {/* Description */}
  <p className="text-white/60 text-xs text-center line-clamp-3 absolute transition-opacity duration-300 group-hover/canvas-card:opacity-0">
    {solution.description}
  </p>

  {/* Try Now Button */}
  <div className="absolute opacity-0 group-hover/canvas-card:opacity-100 transition-opacity duration-300">
    <LoginLink 
      postLoginRedirectURL={`/services/${solution.slug}`}
      className="inline-flex items-center justify-center px-6 py-2 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white font-semibold rounded-md transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl"
    >
      Try Now
    </LoginLink>
  </div>
