        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {stats.map((stat, index) => {
            ...
            return (
              ...
              >
                <div className={`relative h-full p-8 rounded-3xl backdrop-blur-xl transition-all duration-500 group-hover:transform group-hover:scale-105 overflow-hidden border ${
                  hoveredIndex === index 
