...
interface LoadingActions {
  startLoading: (text?: string, id?: string | null) => void;
  setProgress: (progress: number) => void;
  setLoadingText: (text: string) => void;
  completeLoading: (id?: string | null) => void;
  resetLoading: () => void;
}
...
export const loadingActions = {
  start: (text?: string, id?: string | null) => useLoadingStore.getState().startLoading(text, id),
  ...
  complete: (id?: string | null) => useLoadingStore.getState().completeLoading(id),
